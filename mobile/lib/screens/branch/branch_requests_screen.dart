  ...
  Widget build(BuildContext context) {
    return Column(
      ...
      children: [
        ...
        Row(
          children: [
            // Name and decision time together, so the branch can see when
            // each approver signed off rather than only that they did.
            Expanded(
              child: SpecTile(
                label: 'Admin',
                value: request.adminDecidedBy.isEmpty
                    ? 'Not decided yet'
                    : request.adminDecidedBy,
                caption: request.adminDecidedOn == null
                    ? ''
                    : formatDateTime(request.adminDecidedOn),
              ),
            ),
            Expanded(
              child: SpecTile(
                label: 'Supervisor',
                value: request.supervisorDecidedBy.isEmpty
                    ? 'Not decided yet'
                    : request.supervisorDecidedBy,
                caption: request.supervisorDecidedOn == null
                    ? ''
                    : formatDateTime(request.supervisorDecidedOn),
              ),
            ),
          ],
        ),
