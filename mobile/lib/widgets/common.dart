...
class MetricCard extends StatelessWidget {
  ...
  /// Optional line under the number, e.g. this account's share of a
  /// store-wide count.
  final String caption;
...
class SpecTile extends StatelessWidget {
  ...
  /// Optional muted line under the value, e.g. the time a decision was made.
  final String caption;
...
class PanelHeader extends StatelessWidget {
  ...
  /// Optional line under the title, e.g. this supervisor's share of a shared list.
  ...
  Widget build(BuildContext context) {
    return Row(
      crossAxisAlignment:
          subtitle.isEmpty ? CrossAxisAlignment.center : CrossAxisAlignment.start,
      children: [
