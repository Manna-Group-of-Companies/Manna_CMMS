...
import { RequestStatusBadge, ApprovalStages, RequestHistory } from "./RequestStatus";
import {
  Loader2,
  Check,
  X,
                      ...
                      <div className="grid grid-cols-2 gap-3">
                        ...
                        <div>
                          ...
                          <p className="font-semibold text-slate-900">
                            {request.branch?.name} ({request.branch?.email})
                          </p>
                        </div>
                        <div>
                          <p className="text-slate-500">Admin decision</p>
                          <p className="font-semibold text-slate-900">
                            {request.admin?.name || "Pending"}
                          </p>
                        </div>
                        <div>
                          <p className="text-slate-500">Supervisor decision</p>
                          <p className="font-semibold text-slate-900">
                            {request.supervisor?.name || "Pending"}
                          </p>
                        </div>
                      </div>
                      {request.purpose && (
